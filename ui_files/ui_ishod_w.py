...
class Ui_DialogIshodDocx(object):
    def setupUi(self, DialogIshodDocx):
        ...
        self.label_NameFile.setToolTip("")
        ...
        self.checkBox_FolderNesting.setChecked(True)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/folder_refresh_icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pBtn_UpdateTable.setIcon(icon1)
    ...
    def retranslateUi(self, DialogIshodDocx):
        ...
        self.lineEdit_NameDocx.setPlaceholderText(_translate("DialogIshodDocx", "ИТНЯ.*****.**-*"))
